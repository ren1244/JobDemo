...
class LineAPIModel extends CI_MODEL
{
    ...
    public function setConsts($channelSecret, $channelAccessToken, $otherResources=[])
    {
        $this->channelSecret=$channelSecret;
        $this->channelAccessToken=$channelAccessToken;
        $this->resources=$otherResources;
    }
    ...
    {
        return $this->source['userId']?$this->source['userId']:false;
    }
    
    public function getSourceId()
    {
        return $this->source['groupId'] || $this->source['roomId'] || $this->source['userId'];
    }
    ...
    public function getProfit()
    {
        ...
        $r=$this->sendRequest(
            'get',
            'https://api.line.me/v2/bot/profile/'.$this->source['userId'],
            [
                'Authorization: Bearer {'.$this->channelAccessToken.'}'
            ]
        );
